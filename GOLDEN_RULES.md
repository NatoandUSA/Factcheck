...
**Ratified by:** Owner (Alex), 2026-08-25; GPT1 authority hierarchy ratified 2026-08-26
...
|---|---|---|---|
| 1 | Commit `GOLDEN_RULES.md` ở gốc repo | GPT3 | ✅ candidate này |
| 2 | `PROJECT_RULES.md` → stub trỏ về đây | GPT3 | ✅ candidate này |
| 3 | `PROJECT_GUIDE_*.md` → xoá §13, §21; thêm header trỏ về đây | GPT3 | ✅ candidate này |
| 4 | `GPT1_GPT2_INTEGRATION_CHECKLIST.md` → `docs/operational/` | GPT3 | ✅ candidate này |
