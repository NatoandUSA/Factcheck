...
const ROUTES = [
  ...
  { method: 'POST', path: '/api/projects/:id/amazon/asin-batches/preview', public: false },
  { method: 'POST', path: '/api/projects/:id/amazon/asin-batches', public: false },
  { method: 'POST', path: '/api/projects/:id/amazon/cerebro-bindings', public: false },
